...
impl ProviderData <'_> {
    pub fn getGoogle() -> Self {
        ...
        ProviderData {
            ...
            issuer_decoded: "794a7063334d694f694a6f64485277637a6f764c32466a59323931626e527a4c6d6476623264735a53356a623230694c43", // "https://accounts.google.com",
            index_mod_4: 1,
            kid: google_kid,
    ...
    pub fn getKakao() -> Self {
        ...
        ProviderData {
            ...
            issuer_decoded: "496d6c7a63794936496d68306448427a4f6938766132463164476775613246725957387559323974496977", //"https://kauth.kakao.com",
            index_mod_4: 0,
            kid: kakao_kid,
    ...
    pub fn getFacebook() -> Self {
        ...
        ProviderData {
            ...
            issuer_decoded: "794a7063334d694f694a6f64485277637a70634c317776643364334c6d5a6859325669623239724c6d4e7662534973", // "https://www.facebook.com",
            index_mod_4: 1,
            kid: facebook_kid,
